...
export default function Wedding() {
    ...
    const submit = async () => {
        ...
        try {
            await ApiInstance.post("/weddings", model)
                .then((res) => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.heading}>Apply for a Wedding Loan</Text>
            <TextInput
                style={styles.input}
                placeholder="Event Name"
                placeholderTextColor="#aaa"
                onChangeText={(e) => setModel({ ...model, event: e })}
                value={model.event || ""}
            />
            <TextInput
                style={styles.input}
                ...
                onChangeText={(e) => setModel({ ...model, loan: e })}
                value={model.loan || ""}
            />
            <TextInput
                style={styles.input}
